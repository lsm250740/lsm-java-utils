...
public class ReflectionInvocationHandler implements InvocationHandler {
    ...
    ReflectionInvocationHandler( JavaAnnotation<?> annotation, Map<String, ?> values ) {
    ...
    private Boolean isEqual( Object other ) {
        ...
        if ( type.isInstance( other ) ) {
            ...
            Map<String, Object> otherValues = ReflectionAnnotationUtils.getAnnotationValues( otherAnnotation );
